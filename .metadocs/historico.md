...
- **17/06/2026**: Consolidação de Documentação — migração de todos os docs de mecânicas de `mecanicas/` para `documents/` via `git mv`; documentação de 303 propriedades de sprite e mapeamento de ferramentas/materiais em `documents/`.
