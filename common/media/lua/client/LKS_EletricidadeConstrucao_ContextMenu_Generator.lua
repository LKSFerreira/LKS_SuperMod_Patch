...
--           Tradução completa de engenharia e padronização de prefixos LKS_EletricidadeConstrucao_
-- AUTOR: LKSFERREIRA
...
if not LKS_EletricidadeConstrucao then
    print(
    "[LKS PATCH - LKS_EletricidadeConstrucao_ContextMenu_Generator.lua] namespace LKS_EletricidadeConstrucao não encontrado - pulando carregamento do módulo")
    return
end

print("[LKS PATCH - LKS_EletricidadeConstrucao_ContextMenu_Generator.lua] Carregando Menu de Contexto do Gerador com padronização de ícones...")
...
-- ============================================================================
-- ⚙️ CONFIGURAÇÕES DE ASSETS E TEXTURAS (PADRÃO DE NOMENCLATURA LKS_EletricidadeConstrucao)
-- ============================================================================
...
function ContextMenu.OnTurnOn(worldobjects, player)
    ...
    if LKS_EletricidadeConstrucao.Actions and LKS_EletricidadeConstrucao.Actions.ActivateGenerator then
        ISTimedActionQueue.add(LKS_EletricidadeConstrucao.Actions.ActivateGenerator:new(playerObj, generator, true))
    else
        print(
        "[LKS PATCH - LKS_EletricidadeConstrucao_ContextMenu_Generator.lua] ERRO: LKS_EletricidadeConstrucao.Actions.ActivateGenerator não encontrado!")
    end
end
...
function ContextMenu.OnTurnOff(worldobjects, player)
    ...
    if LKS_EletricidadeConstrucao.Actions and LKS_EletricidadeConstrucao.Actions.ActivateGenerator then
        ISTimedActionQueue.add(LKS_EletricidadeConstrucao.Actions.ActivateGenerator:new(playerObj, generator, false))
    else
        print(
        "[LKS PATCH - LKS_EletricidadeConstrucao_ContextMenu_Generator.lua] ERRO: LKS_EletricidadeConstrucao.Actions.ActivateGenerator não encontrado!")
    end
...
function ContextMenu.OnConnectBuilding(worldobjects, player)
    ...
    if LKS_EletricidadeConstrucao.Actions and LKS_EletricidadeConstrucao.Actions.ConnectBuilding then
        ISTimedActionQueue.add(LKS_EletricidadeConstrucao.Actions.ConnectBuilding:new(playerObj, generator))
    else
        print(
        "[LKS PATCH - LKS_EletricidadeConstrucao_ContextMenu_Generator.lua] ERRO: LKS_EletricidadeConstrucao.Actions.ConnectBuilding não encontrado!")
    end
end
...
function ContextMenu.OnDisconnectBuilding(worldobjects, player)
    ...
    if LKS_EletricidadeConstrucao.Actions and LKS_EletricidadeConstrucao.Actions.DisconnectBuilding then
        ISTimedActionQueue.add(LKS_EletricidadeConstrucao.Actions.DisconnectBuilding:new(playerObj, generator))
    else
        print(
        "[LKS PATCH - LKS_EletricidadeConstrucao_ContextMenu_Generator.lua] ERRO: LKS_EletricidadeConstrucao.Actions.DisconnectBuilding não encontrado!")
    end
end
