...
4.  Reescreve o banco [dicionario_tilesets.json](../tools/data/dicionario_tilesets.json) limpo e com suporte a UTF-8, garantindo que novas adições do jogo fiquem disponíveis na CLI de busca imediatamente.
